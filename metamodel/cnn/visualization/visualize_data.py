...
def plot_target_prediction(all_targets, all_predictions, title_prefix="", r2=[None, None, None, None, None, None],
                           nrmse=[None, None, None, None, None, None], x_labels=[r'$k_{xx}$', r'$k_{xy}$', r'$k_{yy}$'], titles=['k_xx', 'k_xy', 'k_yy']):
