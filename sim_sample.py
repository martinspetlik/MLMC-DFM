...
class FlowSim(Simulation):
    ...
    def calculate(config, seed):
        ...
        fine_res, fine_flow_run_time = FlowSim._run_sample(fields_file, fine_mesh_data['ele_ids'], fine_input_sample,
                                                           flow123d,
                                                           fine_common_files_dir,
                                                           os.path.join(fine_common_files_dir, FlowSim.MESH_FILE))
        ...
        if coarse_input_sample:
            coarse_res, coarse_flow_run_time = FlowSim._run_sample(fields_file, coarse_mesh_data['ele_ids'],
    ...
    def _run_sample(fields_file, ele_ids, fine_input_sample, flow123d, common_files_dir, mesh_file):
        ...
        return FlowSim._extract_result(os.getcwd()), end
